...
303 redirect to `thank-you.html` or `pt/thank-you.html` according to the
`lang` field. `form_type` tells the forms apart. The field contract is in
`CHANGELOG.md` v1.53.
...
no screening of its own any more: the honeypot is a field named `website`
